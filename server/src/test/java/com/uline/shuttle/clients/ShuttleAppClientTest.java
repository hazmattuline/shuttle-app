...
public class ShuttleAppClientTest {
    ...
    @InjectMocks
    ShuttleAppClientImpl shuttleAppClient;
    ...
    public void setup() throws IllegalAccessException {
        ...
        FieldUtils.writeField(shuttleAppClient, "statusShuttlesURL", "/shuttles?status=status={status}", true);
        FieldUtils.writeField(shuttleAppClient, "shuttlePostCoordinates", "/shuttles/{id}/coordinates", true);
        ...
        FieldUtils.writeField(shuttleAppClient, "getTripURL", "/shuttle-trips?date={date}&vehicle={vehicle}",true);
        FieldUtils.writeField(shuttleAppClient, "getRoutesURL", "/shuttle-routes", true);
        FieldUtils.writeField(shuttleAppClient, "getDayURL", "/shuttle-days?date={date}&vehicle={vehicle}", true);
    ...
    public void testChangeStatus() {
        ...
        Assert.assertEquals(shuttleRequest.getLatitudeCoordinates(), shuttleResponse.getLatitudeCoordinates());
        Assert.assertEquals(shuttleRequest.getLongitudeCoordinates(), shuttleResponse.getLongitudeCoordinates());
    ...
    public void testGetRoutes() {
        ...
        Assert.assertEquals(routeResponses.get(0).getFromWarehouseDoor(), routeResponse.getFromWarehouseDoor());
        ...
        Assert.assertEquals(routeResponses.get(0).getToWarehouseDoor(), routeResponse.getToWarehouseDoor());
    ...
    public void testGetShuttleStatus() {
        ...
        Assert.assertEquals(shuttleResponses.get(0).getLatitudeCoordinates(), shuttleResponse.getLatitudeCoordinates());
        Assert.assertEquals(shuttleResponses.get(0).getLongitudeCoordinates(), shuttleResponse.getLongitudeCoordinates());
        ...
        Assert.assertEquals(shuttleResponses.get(0).getRentalIndicator(), shuttleResponse.getRentalIndicator());
    }
