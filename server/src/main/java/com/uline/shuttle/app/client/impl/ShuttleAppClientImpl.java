...
public class ShuttleAppClientImpl implements ShuttleAppClient {
  ...
  public ShuttleResponse changeStatus(StatusRequest statusRequest, Integer id) {
    ...
    return restTemplate.exchange(builder.buildAndExpand(params).toUriString(), HttpMethod.PATCH,
        new HttpEntity<>(statusRequest), new ParameterizedTypeReference<ShuttleResponse>() {}).getBody();
  }
  ...
  public EndResponse endShift(EndRequest endRequest) {
    ...
    return restTemplate.exchange(builder.build().toUriString(), HttpMethod.POST, new HttpEntity<>(endRequest),
  ...
  public CoordinateResponse enRoute(Integer vehicleID, CoordinateRequest coordinateRequest) {
    ...
    UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(baseUrl + shuttlePostCoordinates);

    return restTemplate.exchange(builder.buildAndExpand(params).toUriString(), HttpMethod.PATCH,
        new HttpEntity<>(coordinateRequest), new ParameterizedTypeReference<CoordinateResponse>() {}).getBody();
  }
  ...
  public List<ShuttleResponse> getActiveShuttles() {
    ...
    return restTemplate.exchange(builder.build().toUriString(), HttpMethod.GET, new HttpEntity<>(null, null),
        new ParameterizedTypeReference<List<ShuttleResponse>>() {}).getBody();
  }
  ...
  public List<VehicleOptionsResponse> getVehicles() {
    ...
    return restTemplate.exchange(builder.build().toUriString(), HttpMethod.GET, null,
        new ParameterizedTypeReference<List<VehicleOptionsResponse>>() {}).getBody();
  }
